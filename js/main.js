...
const articles = [
    ...
    { 
        file: 'javascript-tips.md', 
        title: 'Полезные советы по JavaScript', 
        date: '2025-01-25', 
        excerpt: 'Собрал несколько полезных советов и трюков для повседневной работы с JavaScript.',
        tags: ['javascript', 'программирование', 'советы']
    },
    { 
        file: 'git-workflow.md', 
        title: 'Эффективный Git workflow', 
        date: '2025-01-28', 
        excerpt: 'Как организовать работу с Git в команде. Советы по ветвлению и коммитам.',
        tags: ['git', 'devops', 'команда']
    }
];
